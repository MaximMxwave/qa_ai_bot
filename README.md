...
| Создать банковскую карту | `/payment` | Создание тестовых платежных карт |
| Создать Pairwise тест | `/pairwise` | Создание оптимальных тестовых комбинаций |
| Проверить JSON | `/json` | Проверка синтаксиса и форматирования JSON |
| Создать тест-кейс | `/testcase` | Создание шаблонов тест-кейсов |
| Создать баг-репорт | `/bug` | Создание структурированных баг-репортов |
| Создать тестовые данные | `/testdata` | Создание тестовых данных пользователей |

### 🗂 Создать файл
* Создание тестовых файлов различных форматов (DOCX, XLSX, TXT, PDF, CSS, HTML, JS, JSON, ZIP, RAR, MP4, AVI)
...
* Создание профилей тестовых пользователей
