...
|--------|---------|----------|
| Генератор баг-репортов | `/bug` | Создание структурированных баг-репортов |
| Генератор файлов | `/file` | Генерация тестовых файлов различных форматов |
| Валидатор JSON | `/json` | Проверка синтаксиса и форматирования JSON |
...
* Готовый шаблон с основными полями
